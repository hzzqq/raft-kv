...
| `diagnostics` | 2 | 3 | ✅ | — |
| `gateway` | 8 | 27 | ✅ | Flush, LoadGatewayConfig, SetCORS, SetHTTPServer, GroupStatus, GroupView, RaftStatusView |
| `kvadmin` | 1 | 0 | ❌ | — |
| `kvcli` | 16 | 28 | ✅ | MSetCtx, Unwrap, BatchResult, BenchResult, MDelResult, MSetResult |
| `kvnode` | 2 | 3 | ✅ | — |
| `kvraft` | 1 | 4 | ✅ | OpResult |
...
> 汇总：18 个包，1 个无测试；未引用导出符号 func=36 / type=21 / var=2 / const=0。「未覆盖符号」为软提示，可能含被间接覆盖的结果/视图类型。
